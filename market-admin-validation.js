(function initMarketAdminValidation(globalScope) {
  ...
  const FRIENDLY_ERRORS = [
    ...
    ["VERIFICATION_REQUIRED", "La candidata necesita una comprobación factual concluyente antes de preparar el borrador."],
    ["VERIFICATION_EXPIRED", "La comprobación factual ha caducado. Actualiza el Radar antes de continuar."],
