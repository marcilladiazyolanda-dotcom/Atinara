(function initMarketAdminValidation(globalScope) {
  ...
  const STATUS_LABELS = {
    ...
    draft_ready_for_validation: "Listo para Validator",
    draft_with_repairable_issues: "Borrador con incidencias reparables",
    draft_waiting_authoritative_source: "Esperando fuente oficial",
    draft_human_edit_required: "Edición humana necesaria",
    review_pending: "Revisión pendiente",
    review_in_progress: "Revisión en curso",
    review_rejected: "Rechazado",
    review_rejected_repairable: "Revisión bloqueada · corregible",
    review_rejected_terminal: "Revisión terminal",
    ...
    repair_pending: "Corrección pendiente",
    repair_in_progress: "Corrección en curso",
    repair_applied: "Corrección aplicada · revalidar",
    repair_waiting_source: "Corrector esperando fuente oficial",
    repair_human_decision_required: "Decisión humana necesaria",
    repair_not_supported: "Reparación no disponible",
    repair_failed_technical: "Incidencia técnica del Corrector",
    human_confirmed: "Confirmación humana completada",
    publication_revalidation_required: "Revalidación de publicación pendiente",
    publication_blocked_recoverable: "Publicación bloqueada · recuperable",
    publication_failed_terminal: "Publicación terminal",
  ...
  const FRIENDLY_ERRORS = [
    ...
    ["NORMALIZER_OUTDATED", "La candidata debe actualizarse con el normalizador vigente. Actualiza el Radar y vuelve a intentarlo."],
    ["ELIGIBILITY_POLICY_OUTDATED", "La candidata debe revisarse con el criterio predictivo vigente. Actualiza el Radar."],
    ["ELIGIBILITY_REQUIRED", "La candidata necesita una decisión de elegibilidad vigente antes de preparar el borrador."],
    ["ELIGIBILITY_EXPIRED", "La elegibilidad ha caducado. Actualiza el Radar antes de continuar."],
    ["RESOLUTION_SOURCE_REQUIRED", "La candidata no conserva una pregunta, criterios y fuente de resolución verificables."],
    ["CONFIRMED_DUPLICATE", "La candidata coincide con un mercado o borrador existente."],
    ["RADAR_CONFIRMED_DUPLICATE", "La candidata coincide con un mercado o borrador existente."],
    ["CANDIDATE_NOT_PREPARABLE", "La candidata ya no está disponible para preparar."],
    ["CANDIDATE_NOT_FOUND", "La candidata ya no existe en el Radar. Actualiza la lista."],
    ...
    ["RADAR_ELIGIBILITY_REQUIRED", "La comprobación de elegibilidad no pudo concluir. La candidata permanece bloqueada y no se ha preparado ningún borrador."],
    ["MARKET_WORKFLOW_APPROVAL_BLOCKED", "Una incidencia abierta bloquea únicamente la aprobación. Abre el agente responsable o edita el borrador."],
    ["MARKET_WORKFLOW_CONFIRMATION_BLOCKED", "Una incidencia abierta impide confirmar esta versión. El borrador y la revisión se conservan."],
    ["MARKET_WORKFLOW_PUBLICATION_BLOCKED", "Una incidencia abierta impide publicar. El borrador conserva su estado y muestra la siguiente acción."],
    ["RADAR_DRAFT_ELIGIBILITY_BINDING_REQUIRED", "La publicación necesita una comprobación de elegibilidad ligada a esta versión exacta. Atinara puede repetirla sin cambiar el borrador."],
    ["INVALID_DRAFT_ELIGIBILITY_SCOPE", "La versión privada indicada para la comprobación no es válida. Recarga el borrador."],
    ["RADAR_DRAFT_SCOPE_MISMATCH", "La candidata ya no corresponde a esta versión del borrador. Recarga antes de continuar."],
    ["OFFICIAL_TERMINAL_SCAN_UNAVAILABLE", "La comprobación oficial de resultados conocidos no terminó. Se conserva el último expediente válido y puedes reintentar."],
    ["SELF_LINEAGE_REVALIDATION_REQUIRED", "Atinara excluyó el propio borrador del análisis de duplicados y debe renovar la elegibilidad antes de publicar."],
    ["ELIGIBILITY_SCAN_UNAVAILABLE", "No se pudo descartar de forma segura un resultado oficial ya conocido. El estado anterior se conserva y puedes reintentar."],
    ["CANDIDATE_NOT_REVALIDATABLE", "Esta candidata ya no admite una comprobación de elegibilidad porque fue descartada, caducó o alcanzó un estado terminal."],
    ...
    ["RADAR_CANDIDATE_INELIGIBLE", "La candidata no es temporalmente compatible con el contrato o ya no está disponible."],
    ["RADAR_CANONICAL_URL_INVALID", "No se pudo validar la fuente o el enlace canónico de la candidata."],
