...
checkpoint anterior `4177f84` contenía exactamente las diez rutas del ZIP
...
verificados. Después se desplegó únicamente `market-radar`: v75, `ACTIVE`,
...
anterior omitía la lectura y el parse del body. La ruta completa sobre 13.559
