...
test("los errores de procedencia tienen explicación humana y el navegador recibe los scripts nuevos", () => {
  ...
  assert.match(adminHtml, /market-admin-validation\.js\?v=20260828-radar-editor-domain1/);
  assert.match(adminHtml, /official-opportunity-request\.js\?v=20260828-radar-editor-domain1/);
  assert.match(adminHtml, /admin-markets\.js\?v=20260828-radar-editor-domain1/);
});
