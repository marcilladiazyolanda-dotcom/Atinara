...
test("Datos y tendencias conserva análisis, autofill y guardado como acciones humanas separadas", () => {
  ...
  assert.match(observatoryHtml, /official-opportunity-request\.js\?v=20260825-radar-catalog-bound1/);
  assert.match(observatoryHtml, /admin-markets\.js\?v=20260825-radar-provider-checkpoint1/);
  assert.match(observatoryHtml, /styles\.css\?v=20260825-radar-catalog-bound1/);
});
